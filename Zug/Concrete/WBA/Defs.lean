...
/-- Node N has WBA output b at time t: received > 2f readies for b. -/
...
theorem hasWBAOutput_unique {inst : WBAInstance}
  ...
  obtain ⟨C, hC_correct, hC_b₁, hC_b₂⟩ := qa.super_majority_intersection h₁' h₂'
